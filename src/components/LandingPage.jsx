      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-gray-900">Quick Peek Pro</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              href="#pricing"
              className="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-500 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-indigo-600 transition-all shadow-lg shadow-indigo-500/25 flex items-center gap-2"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100">
            <div className="flex flex-col gap-4">
              <a href="#features" className="text-gray-600 hover:text-indigo-600 font-medium">
                Features
              </a>
              <a href="#how-it-works" className="text-gray-600 hover:text-indigo-600 font-medium">
                How it Works
              </a>
              <a href="#pricing" className="text-gray-600 hover:text-indigo-600 font-medium">
                Pricing
              </a>
              ...
              <a
                href="#pricing"
                className="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-500 text-white rounded-xl font-semibold text-center flex items-center justify-center gap-2"
              >
                <Chrome className="w-4 h-4" />
                Add to Chrome
              </a>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
            See item details, updates, and status columns instantly with a quick hover. 
            No more endless clicking to find information in Monday.com.
          </p>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-gray-500 text-sm">
              Trusted by <span className="font-semibold text-gray-700">2,000+</span> Monday.com power users
            </p>
          </div>
        </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-gray-700 font-medium">Launch Marketing Campaign</span>
                      <div className="ml-auto flex gap-2">
                        <div className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-medium">Done</div>
                        <div className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs">John D.</div>
                      </div>
                    </div>
                    {/* Tooltip */}
                    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 bg-gray-900 text-white p-4 rounded-xl shadow-2xl w-72 z-10">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-emerald-400 text-sm font-medium">Quick Peek Active</span>
                      </div>
                      <h4 className="font-semibold mb-2">Launch Marketing Campaign</h4>
                      <p className="text-gray-400 text-sm mb-3">Final review completed. Ready for Q1 launch with full social media strategy.</p>
                      <div className="flex gap-2 text-xs">
                        <span className="px-2 py-1 bg-emerald-500/20 text-emerald-400 rounded">Status: Done</span>
                        <span className="px-2 py-1 bg-indigo-500/20 text-indigo-400 rounded">Priority: High</span>
                      </div>
                  ...
                  <div className="flex items-center gap-4 p-3 rounded-lg opacity-50">
                    ...
                    <div className="ml-auto flex gap-2">
                      <div className="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-medium">In Progress</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-3 rounded-lg opacity-50">
                    ...
                    <div className="ml-auto flex gap-2">
                      <div className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs font-medium">Not Started</div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  const painPoints = [
    {
      ...
      description: 'Opening every single item just to see basic details? That adds up to hours of wasted time.',
    },
    {
      icon: Timer,
      title: 'Context Switching Hell',
      description: 'Lose focus every time you click away. Your brain needs 23 minutes to refocus!',
    },
    {
      icon: Layers,
      title: 'Information Buried Deep',
      description: 'Updates, status changes, and notes hidden behind multiple clicks and scrolls.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Monday.com is powerful, but navigating it can feel like a workout for your mouse finger.
          </p>
        </div>
  ...
  const features = [
    {
      ...
      description: 'Hover over any item to see its full details, updates, and status without clicking.',
      color: 'indigo',
    },
    {
      icon: Zap,
      title: 'Lightning Fast',
      description: 'Zero loading time. Information appears instantly as you hover.',
      color: 'yellow',
    },
    {
      icon: Palette,
      title: 'Beautiful Tooltips',
      description: 'Clean, modern design that matches Monday.com\'s aesthetic perfectly.',
      color: 'pink',
    },
    {
      icon: Settings,
      title: 'Customizable Display',
      description: 'Choose what information shows in tooltips. Status, dates, people, and more.',
      color: 'emerald',
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Works automatically on any Monday.com board. No setup required.',
      color: 'purple',
    },
  ];
    ...
    <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Quick Peek Pro is designed to make your Monday.com experience faster and more efficient.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${colorClasses[feature.color]} group-hover:scale-110 transition-transform`}>
...
const HowItWorksSection = () => {
  const steps = [
    {
      ...
      description: 'Add Quick Peek Pro to Chrome in one click. No account needed.',
      icon: Chrome,
    },
    {
      number: '02',
  ...
  return (
    <section id="how-it-works" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 to-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
  ...
  const faqs = [
    {
      ...
      answer: 'Absolutely! Quick Peek Pro processes everything locally in your browser. Your data never leaves your computer and is never sent to any external servers. We take privacy seriously.',
    },
    {
      question: 'Does it work with all Monday.com boards?',
      answer: 'Yes! Quick Peek Pro works with any board type - Main boards, Private boards, Shareable boards, and even Dashboard views. It automatically detects Monday.com pages.',
    },
    {
      question: 'Will it slow down Monday.com?',
      answer: 'Not at all. Quick Peek Pro is highly optimized and only activates when you hover over items. There\'s no impact on page load times or Monday.com performance.',
    },
    {
      question: 'Can I customize what shows in tooltips?',
      answer: 'Pro users can fully customize tooltip content. Choose which columns to display, set the order, and even create custom layouts for different board types.',
    },
    {
      question: 'What\'s the difference between Free and Pro?',
      answer: 'The free version includes basic hover tooltips with item name, description, and status. Pro unlocks all 20+ column types, custom layouts, updates preview, and advanced features.',
    },
    {
      question: 'How do I cancel my subscription?',
      answer: 'You can cancel anytime from your account settings. No questions asked. You\'ll continue to have Pro access until the end of your billing period.',
    },
  ];
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-white">Quick Peek Pro</span>
            </div>
            <p className="text-gray-500 max-w-md leading-relaxed">
              The essential Chrome extension for Monday.com power users. 
              See item details with a simple hover.
            </p>
          </div>
